        ...
        <div id="checkid" class="card card1 mx-auto mt-5" style="width: 45rem;">
            <div class="card-body">
                ...
                <form action="" method="get">
                    <div class="row">
                        <div class="col">
                            <input id="useridcodm" type="number" class="form-control text-center hidenumber" placeholder="Masukkan User Id">
                        </div>
                    </div>
                    <!-- <input type="hidden" id="username"> -->
                    <input type="hidden" id="hargadm">
                    <div class="text-center">
                        <input id="button-check-idcodm" class="check-button btn mt-3 " type="button" value="Check ID">
                    </div>
            ...
            <div class="card-body">
                ...
                <form>
                    <div class="row pt-4">
                        <form action="">
                            @foreach($data as $dm)
                            <div id="item-codm" onclick="harga('{{$dm->harga}}','{{$dm->kode_produk}}','{{$dm->nama_produk}}')" class="linedm mt-2">
                                <h6 class=" mt-2 ml-3"><strong>{{$dm->nama_produk}}</strong></h6>
                                <p id="harga" class="ml-3 deskripsiitem">{{$dm->harga}}</p>
                                <img src="{{ asset('asset/img/cp codm.jpg/')}}" class="itemdm-codm pb-1" height="45px" width="45px" alt="">
                            </div>
                            @endforeach
                        </form>
                    </div>
...
<input type="hidden" id="usernamecodm">
