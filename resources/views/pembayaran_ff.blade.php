...
@section('navbar')
<div class="container-fluid pembayaran-ff py-5">
    <div class="row">
        <!-- <form action="">
        ...
        <div id="checkid" class="card card1 mx-auto mt-5" style="width: 45rem;">
            <div class="card-body">
                ...
                <form action="" method="get">
                    <div class="row">
                        <div class="col">
                            <input id="useridff" type="number" class="form-control text-center hidenumber" placeholder="Masukkan User Id">
                        </div>
                    </div>
                    <!-- <input type="hidden" id="username"> -->
                    <input type="hidden" id="hargadm">
                    <div class="text-center">
                        <input id="button-check-idff" class="check-button btn mt-3 " type="button" value="Check ID">
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form>
                    <div class="row pt-4">
                        <form action="">
                            @foreach($data as $dm)
                            <div id="item-ff" onclick="harga('{{$dm->harga}}','{{$dm->kode_produk}}','{{$dm->nama_produk}}')" class="linedm mt-2">
                                <h6 class=" mt-2 ml-3"><strong>{{$dm->nama_produk}}</strong></h6>
                                <p id="harga" class="ml-3 deskripsiitem">{{$dm->harga}}</p>
                                <img src="{{ asset('asset/img/dm1.jpg/')}}" class="itemdm-ff pb-1" height="57px" width="57px" alt="">
                            </div>
                            @endforeach
                        </form>
                    </div>
...
<input type="hidden" id="usernameff">
...
<div class="modal fade" id="modal-qris" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="bayarakhirqris-ff" class="btn btn-qris1">Check Status Bayar</button>
            </div>
        </div>
    </div>
</div>
